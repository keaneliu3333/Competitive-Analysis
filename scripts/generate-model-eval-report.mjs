...
const lines = [
  ...
  "## 评估口径",
  "",
  "- DeepSeek：用于文本型结构化抽取、500 字以内型号对比总结和低成本文本复核评估。",
  "- Qwen-VL：用于图片、长图和 URL 图片候选的视觉识别评估。",
  "- PDF 兜底：用于原始 PDF 未转图片或视觉识别失败时的人工复核评估。",
  ...
  "## 校准记录模板",
  "",
  "| Case ID | DeepSeek 抽取结论 | Qwen-VL 视觉结论 | DeepSeek 总结结论 | 本地兜底表现 | 人工修订 | 结论 |",
  "| --- | --- | --- | --- | --- | --- | --- |",
  ...cases.map((testCase) => `| ${markdownCell(testCase.id)} | 待记录 | 待记录 | 待记录 | 待记录 | 待记录 | Go / No-Go |`),
  "",
  "## 下一步",
  "",
  "- 用当前 eval 集逐条运行人工校准，记录 DeepSeek 抽取结果、Qwen-VL 视觉结果、DeepSeek 总结结果和本地兜底结果。",
