...
const checks = [
  ...
  },
  {
    ...
    steps: [
      ...
      "未配置 Qwen-VL、原始 PDF 未转图片或请求失败时，确认系统返回待人工确认兜底结果。",
    ],
  ...
  },
  {
    ...
    expected: "页面路线图卡片包含产品名称、价格、Top3 优先级卖点；各品牌分页不溢出。",
  },
  {
    area: "交接与审计",
    steps: [
      "导出产品库 Excel、质量问题 CSV、审计 CSV、用量 CSV 和完整数据包 JSON。",
      "导出完整数据包 JSON，再导入该数据包。",
      "确认导入前自动下载 backup-before-import 备份。",
    ],
    expected: "产品、自定义模块、分析记录、审计日志、保存视图和比较历史可恢复；审计和用量记录可追溯。",
  },
  {
    area: "正式功能使用反馈",
    steps: [
      "打开 `docs/formal-use-runbook.md`，确认使用目标、角色、任务和 Go/No-Go 标准。",
